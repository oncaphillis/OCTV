...
public class AboutActivity extends Activity {
	...
	"     </div> "+
	"     <h1>"+Environment.NAME+" "+Environment.VERSION+"</h1> "+ 
	"     <p> "+
	...
	private final static String _tmdb_postfix = 
	"    </div>"+
	"    <p/>"+
	"    <p>"+ 
	...
	private final static String _trakt_postfix = 
	"    </div>"+
	"    <hr>";
	private final static String _terminal_postfix = 
	"    </div> "+
	"   </div> "+
	"  </body> "+
	" </html> ";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		webview.loadData(_prefix+getBitmapHtml(R.drawable.ic_launcher,new Integer(128),null)+
				_middle+
				getBitmapHtml(R.drawable.tmdb_logo,null,null)+_tmdb_postfix+
				getBitmapHtml(R.drawable.trakt_logo,null,null)+_trakt_postfix+
				debug+
				_terminal_postfix,
